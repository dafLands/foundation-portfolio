...
function qt_custom_breadcrumbs() {
  ...
  if (is_home() || is_front_page()) {
    ...
    if ($showOnHome == 1) echo '<div id="crumbs" class="row"><div class="large-12 columns"><a href="' . $homeLink . '">' . $home . '</a></div></div>';

  } else {

    echo '<div id="crumbs" class="row"><div class="large-12 columns"><a href="' . $homeLink . '">' . $home . '</a> ' . $delimiter . ' ';
